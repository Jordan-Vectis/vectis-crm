        ...
        {isAdmin && (
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#141416] p-5">
            ...
            <div className="mt-3 space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <p className="text-gray-600 dark:text-gray-400">Each row's PhotoFullSizeFile column names its file in that folder, so the new site needs nothing else to pair pictures with lots. This database is <span className="font-semibold">not</span> in the Hub's nightly backup — it is too big for that one file. Neon, the database host, keeps its own restore history that covers it, the original ABC export can be imported again, and the ⬇ Export above is a copy you can keep yourself.</p>
            </div>
          </div>
            }
          />
