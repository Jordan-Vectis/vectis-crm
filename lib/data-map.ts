...
export const DATA_MAP: DataMapArea[] = [
  ...
  },
  {
    ...
    tables: [
      ...
      { model: "SearchWord", what: "Website Search's spelling list: every word in the lot descriptions, how often it appears and its accented spellings, so a misspelt search still finds the lot. Rebuilt from the descriptions weekly." },
      { model: "SearchWordState", what: "When that spelling list was last built, how many words it holds, and any error from the last build." },
      { model: "SearchWordBuild", what: "Scratch space the spelling-list build counts words into; empty between builds." },
    ],
  },
  {
  ...
  },
  {
    ...
    tables: [
      ...
      { model: "StatusService", what: "The Status Centre's current light for each outside service and part of the Hub: working, not working or couldn't tell, and since when." },
      { model: "StatusCheck", what: "The Status Centre's history — each check's result and how long it took. Kept for 30 days." },
      { model: "Notification", what: "An alert in the admin bell, such as a service going down or coming back." },
      { model: "NotificationSeen", personal: "staff", what: "When each admin last opened the bell, so it knows what is unread." },
      { model: "FeedbackSurvey", personal: "staff", what: "A Hub feedback survey: its questions, whether it is open, and which roles or named people it goes to." },
      { model: "FeedbackResponse", personal: "staff", what: "One person's answers to a feedback survey, stored with their name and the exact wording of each question they answered." },
